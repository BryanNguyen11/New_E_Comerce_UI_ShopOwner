...
//           `https://tin-asbestos-papua-consideration.trycloudflare.com/api/products/${productId}`,
//           {
//             method: 'GET',
//             headers: {
//               ...getAuthHeader(),
...
//     if (authState.token || params.id) {
//       fetchProduct();
//     } else {
//       console.log('No token or product ID, skipping fetch');
//       setLoading(false);
//     }
//   }, [params.id, getAuthHeader, authState.token]);
