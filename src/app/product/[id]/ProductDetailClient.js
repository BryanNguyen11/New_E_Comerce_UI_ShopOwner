...
//   const { setTempOrderItem } = useContext(OrderContext);
            ...
            <div className="col-span-7">
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500 text-sm block mt-1">
                      Tặng Voucher ₫15.000 đơn giao sau thời gian trên
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-4 text-black">
                      {product.stock === 0 ? "Hết hàng" : `${product.stock} sản phẩm có sẵn`}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {shopInfo?.userId && (
                    <Link
                      href={`/shop-detail/${shopInfo.userId}`}
                      className="ml-auto px-4 py-2 border border-[#ee4d2d] text-[#ee4d2d] rounded hover:bg-[#fef6f5]"
                    >
                      Xem Shop
                    </Link>
