...
//         const data = await productApi.getProduct(productId, authState.token);
//         console.log('API data:', data);
//         setProduct(data);
//       } catch (err) {
//         console.error('Fetch error:', err.message);
...
//       {/* Product Detail */}
    ...
    //             <img
    //               src={
    //                 product.imageList && product.imageList[selectedImageIdx]
    //                   ? product.imageList[selectedImageIdx]
    //                   : product.coverImage || '/images/product-placeholder.jpg'
    //               }
...
//           <div className="mt-8">
//             <h2 className="text-black text-lg font-medium mb-4">Đánh giá sản phẩm</h2>
//             {/* Placeholder cho ProductReviews */}
//             <div className="bg-gray-50 p-4 rounded">
//               <p className="text-black">Chưa có đánh giá nào.</p>
//               {/* Thay bằng <ProductReviews productId={product.productId} /> khi có component */}
//             </div>
